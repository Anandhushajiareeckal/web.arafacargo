...
<article>
    ...
    <section class="banner mask-overlay pad-120 white-clr">
        <div class="container theme-container rel-div">
            <img class="pt-10 effect animated fadeInLeft" alt="" src="{{asset('frontend/assets/img/icons/icon-1.png')}}" />
                        ...
                        <form class="" action="{{route('tracking')}}" method="POST">
                            ...
                            <div class="col-md-7 col-sm-7">
                                <div class="form-group">
                                    <input type="text" name="tracking_id" placeholder="Enter your product ID" required="" class="form-control box-shadow">
                                </div>
                            </div>
        ...
        <div class="theme-container container">
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    ...
                    <img alt="" src="{{asset('frontend/assets/img/block/about-img.png')}}" class="wow slideInRight" data-wow-offset="50" data-wow-delay=".20s" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="calculate pt-100">
        <div class="theme-container container">
            ...
            <div class="row">
                <div class="col-md-6 text-center">
                    <img src="{{asset('frontend/assets/img/block/Courier-Man.png')}}" alt="" class="wow slideInLeft" data-wow-offset="50" data-wow-delay=".20s" />
                </div>
                <div class="col-md-6">
    ...
    <section class="steps-wrap mask-overlay pad-80">
        ...
        <div class="step-img wow slideInRight" data-wow-offset="50" data-wow-delay=".20s"> <img src="{{asset('frontend/assets/img/block/step-img.png')}}" alt="" /> </div>
    </section>
    <!-- /.Steps -->
            ...
            <div class="row">
                <div class="col-md-11 col-md-offset-1">
                    ...
                    <div class="delivery-img pt-10">
                        <img alt="" src="{{asset('frontend/assets/img/block/delivery.png')}}" class="wow slideInLeft" data-wow-offset="50" data-wow-delay=".20s"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="testimonial-slider no-pagination pad-120">
                <div class="item">
                    <div class="testimonial-img darkclr-border theme-clr font-2 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                        <img alt="" src="{{asset('frontend/assets/img/block/testimonial-1.png')}}" />
                        <span>,,</span>
                    </div>
